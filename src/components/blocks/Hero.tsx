...
export function Hero(props: {
  ...
  return (
    <div className="relative bg-darkPurple w-full flex justify-center items-center">
      ...
      <div className=" max-w-screen-lg mx-auto flex w-full h-full z-40 absolute mt-[20px] md:mt-0 top-0 bottom-0 flex-wrap-reverse mds:flex-nowrap text-white items-center justify-center px-[45px]">
        <div
          className={clsx(
